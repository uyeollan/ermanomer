            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box">
                                <div class="bg-icon bg-icon-pink pull-left"><i class="md md-add-shopping-cart text-pink"></i></div>
                                <div class="text-right">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box">
                                <div class="bg-icon bg-icon-purple pull-left"><i class="md md-equalizer text-purple"></i></div>
                                <div class="text-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card-box">
                                <a href="index.html#" class="pull-right btn btn-default btn-sm waves-effect waves-light">View All</a>
                                <h4 class="text-dark header-title m-t-0">Recent Orders</h4>
                                <p class="text-muted m-b-30 font-13">Use the button classes on an element.</p>
                                    ...
                                    <table class="table table-actions-bar m-b-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="index.html#" class="table-action-btn"><i class="md md-edit"></i></a> <a href="index.html#" class="table-action-btn"><i class="md md-close"></i></a></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td><span data-plugin="peity-line" data-fill="#fff" data-stroke="#5fbeaa" data-width="80" data-height="30">5,3,9,6,5,9,7,3,5,2</span></td>
                ...
                <ul class="list-group contacts-list">
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Chadengle</span> <i class="fa fa-circle online"></i>
                        </a>
                    ...
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Tomaslau</span> <i class="fa fa-circle online"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Stillnotdavid</span> <i class="fa fa-circle online"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Kurafire</span> <i class="fa fa-circle online"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Shahedk</span> <i class="fa fa-circle away"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Adhamdannaway</span> <i class="fa fa-circle away"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Ok</span> <i class="fa fa-circle away"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Arashasghari</span> <i class="fa fa-circle offline"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Joshaustin</span> <i class="fa fa-circle offline"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                    <li class="list-group-item">
                        <a href="index.html#">
                            ...
                            <span class="name">Sortino</span> <i class="fa fa-circle offline"></i>
                        </a>
                        <span class="clearfix"></span>
                    </li>
                </ul>
