    ...
    <div class="wrapper-page">
        <div class="card-box">
            <div class="panel-heading">
				...
				"text-pink">Personel</strong> <strong class=
				"text-custom">Girişi</strong></h3>
            </div>
            <div class="panel-body">
                <form action="<?=  base_url()?>Personal/personal_login" method="post" class="form-horizontal m-t-20">
