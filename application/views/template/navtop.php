...
<div class="topbar">
    <div class="topbar-left">
        <div class="text-center"><a href="<?= base_url() ?>Admin/" class="logo">Bk<span>S KAZAN</span></a></div>
    </div>
            ...
            <div class="">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <?php } else { ?>
                            <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><a class="btn btn-danger" href="<?=  base_url()?>Admin/login">Giriş</a></a>
